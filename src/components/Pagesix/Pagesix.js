...
export default function Pagesix() {
  ...
  <div class = "main">
    <div id="main-div1">
      <div
        style={{ display: "flex", margin: "0px 60px 0px 60px", height: "100%" }}
      >
        <div id="main-div2">
          <div>
            <li>
              <ul className="sub-menu lvl-2 active">
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={15}
                  />
                  <label htmlFor={15}>General Health</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={9}
                  />
                  <label htmlFor={9}>Bone &amp; Joint Support</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={8}
                  />
                  <label htmlFor={8}>Immune Support</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={10}
                  />
                  <label htmlFor={10}>Sleep Support</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={11}
                  />
                  <label htmlFor={11}>Stress Support</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={6}
                  />
                  <label htmlFor={6}>Energy Support</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                ...
                <li className="parent">
                  <input
                    ...
                    id={7}
                  />
                  <label htmlFor={7}>Fitness &amp; Nutrition</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={18}
                  />
                  <label htmlFor={18}>Heart Health</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={12}
                  />
                  <label htmlFor={12}>Digestive Health</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={13}
                  />
                  <label htmlFor={13}>Brain Health</label>
                </li>
                <li className="parent">
                  <input
                    type="checkbox"
                    ...
                    id={14}
                  />
                  <label htmlFor={14}>Eye Health</label>
                </li>
              </ul>
            </li>
          </div>
        ...
        <div id="main-div3">
          <div>
            <h2
              style={{ fontWeight:650, marginBottom: 30, color:"#154946" }}
            >
              PRODUCTS
            </h2>
          </div>
            ...
            <div style={{ display: "flex" }}>
              <div className="main-section-cards">
                <div>
                  ...
                  <h5 className="main-section-cards-h5">SEE ALL CATEGORIES</h5>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div className="main-section-cards">
                <div>
                  ...
                  <p style={{ textAlign: "center", marginBottom: 3 }}>BEAUTY</p>
                  <h5 className="main-section-cards-h5">SEE ALL CATEGORIES</h5>
                  <p className="product-name">
                    Vitamin D3 (Cholecalciferol) 250 MCG (10,000 IU) Softgels
                  </p>
