  ...
  <main>
    <div className="cont-main-div">
      <div className="cont-main-div1">
        <div className="cont-main-div2" style={{ margin: "20px 0px 0px 20px" }}>
          <h2>CONTACT US</h2>
          <p>
        ...
        >
          <div className="cont-main-form1">
            ...
            <p>
              ...
              respond to your inquiry. To learn more about how we use and store
              the information we collect from you, please read our
            </p>
          ...
          <div className="cont-main-form2">
            <form action="">
              <label htmlFor="">What Best Describes Your Question?*</label>
              <br />
