    ...
    <>
      ...
      <div className="py-[8%] xs:pt-[23%] sm:pt-[20%] md:pt-[15%] px-[23%] md:px-[12%] sm:px-[4%]   xs:px-[2%] bg-[#fcfce4] mt-[73px]">
        <div className="">
          ...
          <div className="">
            <p className=" text-lg pb-[1%] pt-[2%]">Welcome to Heiland!</p>
            <p className="  text-lg py-[1%]">
              These terms and conditions outline the rules and regulations for
              the use of Oceanic Herbs LTD's Website, located at
              https://www.heiland.shop/.
            </p>
            <p className="  text-lg py-[1%]">
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Heiland if you do not agree to
            ...
            <h2 className=" py-[2%] font-bold text-2xl">Cookies</h2>
            <p className="  font-normal text-lg  py-[1%]">
              We employ the use of cookies. By accessing Heiland, you agreed to
              use cookies in agreement with the Oceanic Herbs LTD's Privacy
              Policy.
            </p>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <h2 className=" pt-[1%] font-bold text-2xl">License</h2>
            <p className="  font-normal text-lg  py-[1%]">
              Unless otherwise stated, Oceanic Herbs LTD and/or its licensors
              own the intellectual property rights for all material on Heiland.
              All intellectual property rights are reserved. You may access this
              from Heiland for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>
            <p className="  font-normal text-lg  py-[1%]">You must not:</p>
            <ul className="pl-[4%] xs:pl-[5%]">
              <li className=" ext-sm text-lg pb-[1%] list-disc py-[1%]">
                Republish material from Heiland
              </li>
              <li className=" ext-sm text-lg pb-[1%] list-disc py-[1%]">
                Sell, rent or sub-license material from Heiland
              </li>
              <li className=" ext-sm text-lg pb-[1%] list-disc py-[1%]">
                Reproduce, duplicate or copy material from Heiland
              </li>
              <li className=" ext-sm text-lg pb-[1%] list-disc py-[1%]">
                Redistribute content from Heiland
              </li>
            </ul>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <p className="  font-normal text-lg  py-[1%]">
              ...
              Oceanic Herbs LTD does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Oceanic Herbs LTD,its agents
              ...
              by applicable laws, Oceanic Herbs LTD shall not be liable for the
            ...
            <p className="  font-normal text-lg  py-[1%]">
              Oceanic Herbs LTD reserves the right to monitor all Comments and
            ...
            <p className="  font-normal text-lg  py-[1%]">
              You hereby grant Oceanic Herbs LTD a non-exclusive license to use,
              reproduce, edit and authorize others to use, reproduce and edit
              any of your Comments in any and all forms, formats or media.
            </p>
            <h2 className=" pt-[1%] font-bold text-2xl">
            ...
            <p className="  font-normal text-lg  py-[1%]">
              ...
              Oceanic Herbs LTD; and (d) the link is in the context of general
            ...
            <p className="  font-normal text-lg  py-[1%]">
              ...
              by sending an e-mail to Oceanic Herbs LTD. Please include your
            ...
            <p className="  font-normal text-lg  py-[1%]">
              No use of Oceanic Herbs LTD's logo or other artwork will be
              allowed for linking absent a trademark license agreement.
            </p>
            <h2 className=" pt-[1%] font-bold text-2xl">iFrames</h2>
            <p className="  font-normal text-lg  py-[1%]">
              Without prior approval and written permission, you may not create
              frames around our Webpages that alter in any way the visual
              presentation or appearance of our Website.
            </p>
            <h2 className=" pt-[1%] font-bold text-2xl">Content Liability</h2>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <h2 className=" pt-[1%] font-bold text-2xl">Disclaimer</h2>
            <p className="  font-normal text-lg  py-[1%]">
