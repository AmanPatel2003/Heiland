    ...
    <div className="py-[10%] xs:pt-[25%] sm:pt-[20%] md:pt-[15%] px-[27%] lg:px-[20%] md:px-[10%] sm:px-[10%] xs:px-[10%] bg-[#f3ffed] mt-[73px]">
      ...
      <div className="pb-[1%]">
        <p className="py-[1%] font-semibold mb-[2%] ">
          ...
          simplest meals a source of anxiety. While there are various treatments
          available, many individuals are seeking natural and holistic
          approaches to alleviate their acid reflux symptoms. One such solution
        ...
        <p className="py-[1%] font-semibold mb-[2%] ">
          ...
          esophageal sphincter (LES) weakens or relaxes inappropriately. This
          allows stomach acid to flow back into the esophagus, causing
        ...
        <p className="py-[1%] font-semibold mb-[2%] ">
          ...
          are typically intended for short-term use.
        </p>
      </div>
      <div className=" ">
