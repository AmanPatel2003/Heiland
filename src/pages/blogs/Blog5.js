      ...
      <div className="py-[10%] xs:pt-[25%] sm:pt-[20%] md:pt-[15%] px-[27%] lg:px-[20%] md:px-[10%] sm:px-[10%] xs:px-[10%] bg-[#fcfce4] mt-[73px]">
        ...
        <div className="pb-[1%]">
          <p className="mt-[3%]  mb-[1%] ">
            In addition to gas, cramps, and a full feeling, a bloated stomach
            can be unpleasant and even painful. Bloating can have a variety of
            causes, including food intolerances, overeating, and digestive
            problems, but adding specific items to your diet can help reduce the
            discomfort. This post will discuss five foods that can aid in
            promoting digestive health and relieving bloating in the stomach.
          </p>
          ...
          <p className=" my-[1%] ">
            ...
            bioactive ingredient called gingerol, which has anti-inflammatory
            and anti-spasmodic qualities. By helping to relax the muscles in
            your digestive system, gingerol can lessen gas and bloating.
          </p>
          <p className=" mb-[1%] ">
            Ginger can be consumed in a variety of ways, including ground or
            fresh ginger added to meals, fresh ginger tea, and supplements. Not
            only does ginger aid reduce bloating, but it also gives your food a
            delicious flavour.
          </p>
        </div>
        <div className=" ">
          ...
          <p className=" mb-[1%]">
            Another great option for calming an enlarged stomach is peppermint.
            It contains menthol, which can assist relieve gastrointestinal
            discomfort due to its ability to relax muscles. Since peppermint tea
            helps ease gastrointestinal tract tension and minimise gas, it is a
            well-liked treatment for bloating.
          </p>
          ...
          <p className=" mb-[1%] ">
            ...
            digestive system. Live bacterial cultures included in yogurt have
            the potential to regulate the gut microbiome, enhancing digestion
            overall and lowering bloating. When choosing yogurt, look for the
            label that states "live and active cultures" to make sure you're
            getting the probiotic advantages.
          </p>
          <p className=" mb-[1%] ">
            ...
            individuals find easier to stomach. For more taste and nutrients,
            add some fresh fruit or a honey drizzle.
          </p>
          <h1 className="text-lg mb-[1%] font-semibold">Fenestration</h1>
          <p className=" mb-[2%] ">
            For ages, people have used fennel, a versatile vegetable with a
            subtle licorice flavour, to ease digestive pain, including gas and
            bloating. It has ingredients including anethole, which can ease the
        ...
        <div className=" flex sm:block xs:block pb-[5%]">
          <div className="w-[54%] sm:w-[100%] xs:w-[100%] ">
            ...
            <p className="py-[2%] xs:pb-[8%]  ">
              ...
              aid in the fight against bloating. They include a lot of
              potassium, which can help control the sodium balance in your body
              and lessen bloating and water retention. Dietary fibre, which is
              also present in bananas, helps support regular bowel motions and
              ward against constipation, which is another common cause of
              bloating.
            </p>
            <p className="py-[1%] xs:pb-[8%]  ">
              If you're looking for a natural solution to relieve bloating in
              your stomach, try slicing bananas over your muesli or cereal in
              the morning or adding them to smoothies.
            </p>
            ...
            <p className="py-[1%] xs:pb-[8%]  ">
              ...
              more comfortable after eating, support healthy digestion, and
              lessen bloating. To rule out any underlying medical concerns, it's
              crucial to see a healthcare provider if bloating continues or gets
              worse.
            </p>
          </div>
