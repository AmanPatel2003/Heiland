    ...
    <div className="py-[10%] xs:pt-[25%] sm:pt-[20%] md:pt-[15%] px-[27%] lg:px-[20%] md:px-[10%] sm:px-[10%] xs:px-[10%] bg-[#fcfce4] mt-[73px]">
      ...
      <div className="">
        ...
        <p className="mt-[3%]  mb-[1%] ">
          ...
          acid into the esophagus causes symptoms like regurgitation, heartburn,
          and chest pain. In addition to taking medicine to control acid reflux,
          lifestyle adjustments, and natural therapies can be very important to
          live a pleasant life with this problem. We'll look at three practical
