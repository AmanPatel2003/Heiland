      ...
      <div className="py-[8%] xs:pt-[23%] sm:pt-[20%] md:pt-[15%] px-[23%] md:px-[12%] sm:px-[4%]   xs:px-[2%] bg-[#fcfce4] mt-[73px]">
        <div className="">
          ...
          <div className="">
            ...
            <h2 className="  font-bold text-xl">Interpretation</h2>
            ...
            <h2 className=" pt-[1%] font-bold text-xl">Definitions</h2>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <ul className="pl-[4%] xs:pl-[5%]">
              ...
              <li className="  text-lg pb-[1%] list-disc">
                ...
                this Agreement) refers to Oceanic Herbs Ltd, D/601, Avenue 144,
              ...
              <li className="  font-semibol list-disc">
                <strong className="text-green-800 text-lg text-lg">
                  Website
                </strong>{" "}
                refers to Heiland, accessible from{" "}
                <a href="https://www.heiland.shop/" className="text-blue-600">
                  {" "}
            ...
            <h2 className=" py-[1%] font-bold text-lg">Personal Data</h2>
            <p className="  text-lg py-[1%]">
            ...
            <h2 className=" py-[1%] font-bold text-xl">Usage Data</h2>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <h2 className=" py-[1%] font-bold text-xl">
            ...
            <h2 className=" py-[1%] font-bold text-lg">Law enforcement</h2>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <h2 className=" py-[1%] font-bold text-2xl">Children's Privacy</h2>
            <p className="  font-normal text-lg  py-[1%]">
            ...
            <h2 className=" py-[1%] font-bold text-2xl">
            ...
            <h2 className=" py-[1%] font-bold text-2xl">Contact Us</h2>
            <p className="  font-normal text-lg  py-[1%]">
