    ...
    <div className="pt-[9%] xs:pt-[15%] h-full w-full bg-[#fcfce4] mt-[5%] xl:mt-[5%] lg:mt-[6%] md:mt-[7%] sm:mt-[10%] xs:mt-[11%]">
      ...
      <section className="px-[15%] pb-[5%]">
        ...
        <p className="font-semibold text-lg xs:text-base sm:text-base pb-[2%] xs:pb-[5%] sm:pb-[5%]">
          ...
          benefit from the healing properties of herbs. By supporting them, we
        ...
        <p className="font-semibold text-lg xs:text-base sm:text-base pb-[2%]  xs:pb-[5%] sm:pb-[5%]">
          ...
          the tools, knowledge, and resources they need to thrive. In doing so,
        ...
        <p className="font-semibold text-lg xs:text-base sm:text-base pb-[2%] xs:pb-[5%]">
          ...
          significant step toward a healthier, more harmonious world. Together,
          we can bridge the gap between humanity and the healing wonders of
          nature, guided by the unwavering respect and support we give to our
          invaluable farmers.
        </p>
      </section>
