...
export const Advices = () => {
  return (
    <div className="pt-[5%] bg-[#fcfce4]">
      <h1 className="flex justify-center py-[5%] text-5xl font-semibold">
        HEALTH WELLNESS BODY AND SOUL
      </h1>
      <section className="px-[20%] pb-[5%]">
        <p className=" text-justify text-l font-semibold">
      ...
      <section className="px-[5%] pb-[5%] flex justify-between">
        <div className="w-[31%]">
        ...
        <div className="w-[31%]">
          ...
          <p className="font-semibold mb-[2%]">
            <span className="font-bold underline">1. Normal Skin:</span> For normal skin,
            you can mix Mask powder with plain water or rosewater. This
            combination can help rejuvenate and refresh the skin. <br />
          </p>
          <p className="font-semibold mb-[2%]">
            <span className="font-bold underline">2. Oily Skin: </span>To control excess
            oil and reduce acne, blend Mask powder with yogurt or lemon juice.
            The acidity in lemon juice can help balance oil production. <br />
          </p>
          <p className="font-semibold mb-[2%]">
            <span className="font-bold underline"> 3. Dry Skin:</span> For dry skin,
            combine Mask powder with honey or milk. Honey provides moisture,
            while milk adds a creamy texture and hydration. <br />
          </p>
          <p className="font-semibold mb-[2%] ">
            <span className="font-bold underline"> 4. Sensitive Skin: </span>Sensitive
            skin benefits from a mixture of Mask powder and aloe vera gel. Aloe
            vera soothes and calms irritation.
            <br />
          </p>
          <p className="font-semibold mb-[2%]">
            <span className="font-bold underline">5. Combination Skin:</span> If you have
            combination skin, Mask powder with yogurt. This combination can
            address both oily and dry areas on the face.
          </p>
        </div>
      </section>
    </div>
