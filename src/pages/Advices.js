      ...
      <div className=" bg-[#fcfce4] mt-[73px] ">
        ...
        <section className="px-[20%] xs:px-[15%] sm:px-[15%] pb-[5%]">
          <p className=" text-justify  xs:text-sm  text-[18px] font-semibold">
            Incorporating herbal products like tea, skincare, and supplements
            into your daily routine can enhance your overall health. A balanced
            diet supplemented with herbal teas such as chamomile or Hibiscus tea
            provides a nutritious foundation. Herbal skincare products nurture
            your skin naturally. Additionally, Regular exercise, stress
            management through relaxation techniques, and sufficient sleep
            complement the benefits of herbal products, promoting holistic
            well-being. Remember, consistency and patience are essential as
            herbal remedies often require time to manifest their full potential,
            contributing to your long-term health and vitality.
          </p>
        </section>
