        ...
        <div className="flex xs:block sm:block pb-[10%]">
          ...
          <div className="w-[40%] md:w-[45%] lg:w-[45%]  sm:w-full xs:w-full   h-full pr-[5%] md:pr-[5%] sm:px-[4%] xs:px-[4%]">
            ...
            <span className=" text-xl">
              ("Sip into Pure Peppermint Bliss.")
            </span>
              ...
              <div className="flex justify-between">
                <div className="w-full">
                  ...
                  <div className=" items-center mb-[5%] mt-[2%]">
                    <p className="">
                      <b>Daniel:</b>"Peppermint tea is my all-time favorite.
                    ...
                    {reviews ? (
                      <div className="">
                        <p className="pt-[1%]">
                          <b>Grace :</b>"I turn to peppermint tea whenever I
                          need relief from indigestion or nausea. It works like
                          a charm. The cool, refreshing taste is a bonus, and
                          it's a staple in my pantry."
                        </p>
                        <p className="pt-[1%]">
                          <b>Michael :</b>"Peppermint tea is a classic for a
