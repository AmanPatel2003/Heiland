...
import PeppermintImg1 from "../../../img/Heiland/1Tea/6Peppermint/B3.jpg";
import PeppermintImg2 from "../../../img/Heiland/1Tea/6Peppermint/Y1-M.png";
import PeppermintImg3 from "../../../img/Heiland/1Tea/6Peppermint/Y2-M.png";
import PeppermintImg4 from "../../../img/Heiland/1Tea/6Peppermint/Y3-M.png";
...
export const Peppermint = () => {
  ...
  const images = [PeppermintImg1, PeppermintImg2,PeppermintImg3,PeppermintImg4]; // Add more images to the array
      ...
      <section className="pt-[10%] xs:pt-[25%] sm:pt-[15%] md:pt-[15%] lg:pt-[15%] h-full bg-[#f3ffed bg-[#fcfce4] mt-[73px]">
        <div className="flex xs:block sm:block pb-[10%]">
          ...
          <div className="w-[40%] md:w-[45%] lg:w-[45%]  sm:w-full xs:w-full   h-full pr-[5%] md:pr-[5%] sm:px-[4%] xs:px-[4%]">
            ...
            <span className="">("Sip into minty bliss.")</span>
            ...
            <ul className="pl-[6%]">
              ...
              <li className="list-disc mt-[4%]">Improves Respiratory health</li>
              <li className="list-disc mt-[4%]">Weight Management</li>
              <li className="list-disc mt-[4%]">Improves Oral Health</li>
            ...
            <div className="mt-[4%]">
              ...
              <p className="">
                ...
                Peppermint steep for about 5 minutes. After steeping, strain the
